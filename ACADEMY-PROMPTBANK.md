...
### 课程筛选维度
- 类型：Movie making / UGC & Social Content / Automate & Agents
- 难度：Beginner / Intermediate / Advanced
- 时长：<30分钟 / 30-60分钟 / 1-2小时 / 2+小时

---

## 二、Movie Making 课程详情（7门）

### 1. Blockbuster 4K: The AI Filmmaking Pipeline
- **URL**: https://higgsfield.ai/academy/courses/blockbuster-4k
- **难度**: Intermediate | **时长**: 40 min | **模块**: 10
- **描述**: 一个40分钟的教程 - 脚本编写、资产创建、逐场景提示词工程 - 按场景分章节
- **技能**:
  - 将电影故事规划为可制作的节拍序列
  - 构建可复用的角色、道具和场景资产，将故事节拍转化为可控生成
  - 审查并组装选定的片段为完成的短片
- **教学大纲**:
...
### 2. Build an Ultra-Realistic Short Film in 4K
...
- **教学大纲**:
  ...
  3. Write the script with story structure
  4. Character sheets in Soul Cinema
  5. Locations with the 3/4 angle
  6. The prompt-builder skill and first Seedance run
  7. Read your failed takes
  8. The Dutch angle and combining takes
  9. Scene 2 assets: kit, keeper, stadium
  10. The match cut, flares, fog and handheld
  11. One-off characters: the grandfather
  12. Establishing shots and realistic hands
  13. The speed ramp: freezing the penalty
  14. The whip pan and readable text
  15-19. [更多场景和回顾模块]

### 3. Add AI VFX to Real Footage
- **URL**: https://higgsfield.ai/academy/courses/ai-vfx-real-footage
- **难度**: Advanced | **时长**: 12 min | **模块**: 11
- **描述**: 用 Seedance 2.0 将普通摄像机拍摄的画面变成电影级 4K VFX - 世界替换、生物、完整手持展示镜头
- **技能**:
  - 将任何真实片段转为4K VFX镜头，同时保持面部、运动和摄像机
  - 添加生物和世界替换，在手持、移动摄像机画面上保持效果
  - 匹配添加的VFX与底片光线，避免"贴上去"的感觉
- **教学大纲**:
...
### 4. Make an AI Animated Short
- **URL**: https://higgsfield.ai/academy/courses/ai-animated-short
- **难度**: Intermediate | **时长**: 17 min | **模块**: 11
- **描述**: 跨8个不同视觉世界构建一个动画故事，从概念和场景设计到完成的短片
- **技能**:
  - 将一个故事概念转化为可重复的场景计划
  - 设计和评估8种不同动画世界（卧室、追逐、竞技场、屋顶、漫画、黏土、婚礼、结尾）
  - 将场景组装成完整的动画短片
- **教学大纲**:
  1. Why now: Seedance 2.0 goes global
  2. The concept: one story, eight animation styles
  3. Scene 1 - The Bedroom
  4. Scene 2 - The Cowboy Chase
  5. Scene 3 - The Low-Poly Arena
  6. Scene 4 - The Cyberpunk Rooftop
  7. Scene 5 - The Manga World
  8. Scene 6 - Clay Hell
  9. Scene 7 - The Wedding Crash
  10. Scene 8 - The Restaurant Ending
  11. The full film, and the workflow behind it

### 5. How to evaluate AI filmmaking demos
- **URL**: https://higgsfield.ai/academy/courses/seedance-25-ai-filmmaking
- **难度**: Beginner | **时长**: 20 min | **模块**: 11
- **描述**: 学会通过检查摄像机运动、表演、连续性和交付限制来评估AI电影制作演示
- **技能**:
  - 识别证明摄像机运动保持稳定的视觉证据
  - 测试编辑、编舞和变形中的表演和连续性
  - 根据交付限制评判结果并记录支持的制作决策
- **教学大纲**:
  1. Set the test
  2. Read camera motion
  3. Test the music-video cut
  4. Watch the face under strain
  5. Check the choreography
  6. Follow a transformation
  7. Audit a UGC shot
  8. Check cinematic geography
  9. Check the drama
  10. Test an impossible world
  11. Name the trade-off

### 6. Seedance 4K: Cinematic Realism
- **URL**: https://higgsfield.ai/academy/courses/cinematic-realism-4k
- **难度**: Intermediate | **时长**: 14 min | **模块**: 8
- **描述**: 在超精细写实、宽幅人群、真实素材VFX、动画、广告、游戏和快速动作中测试 Seedance 4K
- **技能**:
  - 评估超精细电影画面和不可能的宽镜头的视觉稳定性
  - 判断4K生成如何与真实素材、卡通和CGI整合
  - 测试广告、品牌文字、游戏预告片画面和高速战斗的细节、运动清晰度和交付质量
- **教学大纲**:
  1. Cinematic Realism & Hyper-Detail
  2. The Impossible Shot: 21:9 Crowds
  3. Mixing 4K With Real Footage (VFX)
  4. Cartoon & 2D Animation
  5. 3D Cartoons & CGI
  6. Ads, Brands & Sharp Text
  7. Gaming: Next-Gen Trailers
  8. High-Speed Combat & Final Verdict

### 7. Direct AI fight scenes through controlled iteration
- **URL**: https://higgsfield.ai/academy/courses/direct-ai-fight-scenes
- **难度**: Intermediate | **时长**: 16 min | **模块**: 5
- **描述**: 构建可复用的动作资产，诊断失败的生成，导演比例、变形、冲击和电影覆盖，而不丢失地理或物理
- **技能**:
  - 准备可复用动作资产，用命名元素、空间测量、定时运动和正向约束构建提示词
  - 区分指令错误和生成失败，仅修改失败变量
  - 在保持地理和物理的同时，安排比例、变形、冲击和电影覆盖
- **教学大纲**:
  1. Blueprint the fight before motion
  2. Diagnose and repair a complex shot
  3. Direct scale and transformation with measurements
  4. Preserve physics through the impact cut
  5. Replace game-like coverage with cinematic direction

---

## 三、入门课程（2门基础课程）

### 8. Getting Started with Cinema Studio
- **URL**: https://higgsfield.ai/academy/courses/cinema-studio-complete-tour
- **难度**: Beginner | **时长**: 26 min | **模块**: 12 | **免费生成**: 8次
- **描述**: 在实时工作室中进行你的第一次生成
- **学习内容**:
  - 驱动提示词框：模型、宽高比、批次
  - 构建有效提示词：主体、场景、光线
  ...
  - 正确地编辑、放大或重新生成
  - 组织项目、文件夹和资产流
- **技能**: Prompt Writing / Image Generation / AI Content Creation
- **使用模型**: Soul Cinema / GPT Image 2 / Nano Banana Pro
- **工具**: Cinema Studio
- **教学大纲**:
  1. Introduction
  2. Project tools
  3. The Prompt Box - Image
  4. Spend credits like a producer
  5. Prompt like a director
  6. Try it yourself - your first folder and generation
  7. Edit an image
  8. Why Elements exist
  9. Making and using an Element
  10. Video generation
  11. Edit a video
  12. Find your best plan
...
- **学习内容**:
  ...
  - 从场景开始
  - 保持角色从镜头到镜头的一致性
- **技能**: AI Direction / Character Consistency / Pipeline Design / Asset Management / Slop Control / Agentic Workflows
- **使用模型**: Cinematic Cameras / GPT Image 2 / Nano Banana Pro / Seedance 2.0
- **工具**: Cinema Studio / Claude / Claude Cowork
- **教学大纲**:
  1. Introduction
  2. The pipeline, end to end
  3. Working in Claude
  4. Turning thoughts into a prompt
  5. Name your assets
  6. Section test: the pipeline, Claude & naming
  7. Set up your first project
  8. Choosing your image model
  9. Proof, not promises
  10. Section test: studio & models
  11. Generating locations
  12. Editing locations
  13. Generating characters
  14. Editing characters
  15. Test in Seedance
  16. Spot the slop
  17. Section test: locations, characters & slop
  18. Capstone: set up your production
  19. Capstone: cast your characters
  20. Capstone: build the location
  21. Capstone: dress the scene
  22. Capstone: shoot the scene

---

## 四、UGC & Social Content 课程（7门）

### 10. The 3-Step Realistic AI Ad Workflow
- **URL**: https://higgsfield.ai/academy/courses/ai-ad-3-step
- **难度**: Intermediate | **时长**: 36 min | **模块**: 16
- **描述**: 从零开始构建完全AI生成的商业广告 - 锁定每个资产，用Claude技能将脚本转为连续镜头列表，然后生成和拼接最终场景
- **教学大纲**:
  ...
  12. Scene 2 - the stadium (部分截断)

### 11. Build an AI Ad Agency with Claude + Higgsfield
- **URL**: https://higgsfield.ai/academy/courses/claude-higgsfield-ai-ad-agency
- **难度**: Beginner | **时长**: 22 min | **模块**: 12
- **描述**: 研究利基市场、塑造报价、构建多样化广告组合，用Claude和Higgsfield测试小型客户管道
- **教学大纲**:
  1. Find an underserved niche
  2. Shape the offer
  3. Connect Claude and Higgsfield
  4. Generate a varied portfolio
  5. Design the client intake
  6. Rewrite cold outreach
  7. Build the back office
  8. Turn delivery into a subscription
  9. Add a quality-control gate
  10. Build the sales website
  11. Launch to a qualified list
  12. [更多模块]

### 12. Build a Brand's Visuals with AI
...
- **难度**: Intermediate | **时长**: 35 min | **模块**: 11
- **描述**: 用可复用资产、可控迭代和连续性感知编辑构建电影级汽车广告
- **教学大纲**:
  1. Plan around reusable assets
  2. Build characters for continuity
  3. Assemble a scene from locked references
  4. Cast and clean the plate
  5. Repair continuity with references
  6. Direct dialogue through selection
  7. Make complex driving readable
  8. Correct performance one variable at a time
  9. Stabilize a comic set piece
  10. Block the finale backward
  11. Finish the story in the edit

---

## 五、Automate & Agents 课程（2门）

### 17. Automate a Faceless Niche Channel
- **URL**: https://higgsfield.ai/academy/courses/automate-faceless-niche
- **难度**: Intermediate | **时长**: 10 min | **模块**: 11
- **描述**: 构建无面孔解说频道，包含实时研究、可变现脚本、视频生成、本地化、语音、包装和发布计划
- **教学大纲**:
  1. Intro: The Faceless Explainer System
  2. Setup: Connect the MCP and Install the Skill
  3. Picking a Topic with Live Research
  4. Writing a Script That Stays Monetized
  5. Generating the Full 10-Minute Video
  6. Translating into a Second Language
  7. Cloning Your Own Voice
  8. Titles & Thumbnails in the Same Chat
  9. 20 Shorts in One Click
  10. The 30-Day Content Plan
  11. Outro: Your Move

### 18. Build 3D Games with MCP
- **URL**: https://higgsfield.ai/academy/courses/build-3d-games-mcp
- **难度**: Beginner | **时长**: 12 min | **模块**: 10
- **描述**: 用MCP连接工作流构建和发布三个无代码3D游戏原型，比较输出、成本和早期市场结果
- **技能**:
  - 连接MCP工作流并构建三个不同的游戏原型
  - 用所需展示资产将原型发布到市场
  - 比较MCP辅助工作与Claude单独工作，评估成本、早期结果和工作室反馈
- **教学大纲**:
  1. Intro: Three Real Games, Zero Code
  2. Setup: MCP Connector and Skill
  3. Scene 1: The Pirate Game
  4. With MCP vs. Claude Alone
  5. Scene 2: Blockfield Shooter
  6. Scene 3: NeonSlice Fruit Slicer
  7. Publishing to the Marketplace
  8. The Results I Woke Up To
  9. What Three Games Actually Cost
  10. Studio Reaction and Wrap-Up

---

## 六、Prompt Bank - 完整摄像机运动提示词库（46个）

> 来源: https://higgsfield.ai/academy/apps/prompt-bank
> 设计理念: "运动与场景分离 - 提示词即使更换画面也能工作"
> 分类: Static(1) / Pan & tilt(8) / Zoom & focus(7) / Dolly & tracking(17) / Aerial & crane(6) / Specialty(7)
...
#### 32. Reverse tracking: Walk-and-talk
...
#### 45. Body-mounted camera: Snorricam
...
> 来源: https://higgsfield.ai/seedance/2.5
...
1. **R2V Motion Guidance (运动引导)**
   - 展示白色人物剪影，模型复制其运动

2. **50 Refs (50个参考)**
   - 一次生成中输入所有参考：面孔、产品、服装、场景、风格帧

3. **Nothing Drifts (无漂移)**
   - 保持光线、角色和场景一致性
...
2. **写提示词** - 输入提示词，模型理解物理、光线和情感意图
3. **生成并导出** - 点击"Generate"按钮，几秒内获得高保真视频

### 最佳实践（来自FAQ）
- **提示词写法**: 像镜头列表一样写 - 主体、摄像机、光线、情绪、声音
- **一致性**: 为任何需要保持一致的内容添加参考
- **修正错误**: 用区域编辑而不是重新生成
...
### 适用场景
- **产品广告**: 开场、产品展示、结尾卡片。30秒单次生成，工作室级细节
- **叙事**: 参考每个角色、产品和场景 - 跨多场景长篇叙事流保持一致
- **社交媒体**: 电影级运动、流畅摄像、音频同步。9:16到21:9任意宽高比

### 示例提示词
1. "Handheld medium close-up at golden hour. A young woman with long pastel-pink hair and thin rectangular glasses glances back over her shoulder at the camera, soft smile. Old Shanghai street corner behind her: red brick facades, Chinese signage, zebra crossings, warm backlight, shallow depth of field, filmic vlog look."

2. "Cinematic shot in near-Earth space, a sleek fighter jet banking against the darkness, star streaks behind it, Earth's dark ocean and clouds far below, cold rim light on the fuselage, canopy reflections, deep contrast."

3. "Wide symmetrical shot. A dancer with bleach-blond hair and futuristic sunglasses stands center frame, arms spread wide, mouth open mid-shout. Blue fitted tee over black long sleeves, baggy grey jeans. Behind him a trapezoid portal of horizontal white light panels, everything else pitch black. Pale blue reflective floor, high contrast, clean studio look."
...
1. **脚本阶段**: 用Claude编写故事结构和脚本
2. **资产创建**:
   - 角色表（Soul Cinema模型）
   - 场景/位置（3/4角度拍摄）
   - 道具
3. **提示词构建**: 使用Claude技能将脚本转为镜头列表
4. **视频生成**: 用Seedance 2.0/2.5生成场景
5. **迭代修正**: 诊断失败片段，逐变量修正
6. **编辑组装**: 选择最佳片段，组装成完整影片

### 关键模型
- **Soul Cinema**: 角色表生成
- **GPT Image 2**: 产品图/资产
- **Nano Banana Pro**: 图像编辑
- **Seedance 2.0/2.5**: 视频生成（4K、30秒、音频同步）
- **Cinematic Cameras**: 电影级摄像机控制

### 关键工具
- **Cinema Studio**: 主工作台
- **Claude / Claude Cowork**: 脚本和提示词技能
- **MCP**: 自动化工作流连接

### 提示词写法原则
- **运动与场景分离**: 摄像机运动提示词独立于场景描述
- **使用方括号占位符**: [lens height], [the subject], [composition A] 等
- **明确排除项**: "no pan, no tilt, no zoom, no dolly"
- **包含速度和结束**: 明确运动速度、减速方式和最终构图
- **物理参数**: 使用具体数字（度数、米数、秒数）
